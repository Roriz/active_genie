    ...
    class GoodscoresTest < Minitest::Test
      def test_evaluate_bug_report
        ...
        assert_equal result['final_score'] >= 50, true,
                     "Expected to be at greater than 50, but was #{result['final_score']}, because: #{result['final_reasoning']}"
        assert_equal result['final_score'] <= 80, true,
                     "Expected to be at less than 80, but was #{result['final_score']}, because: #{result['final_reasoning']}"
      end
